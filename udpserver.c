...
/* internal functions */
static int handle_message(uint64_t id, uint8_t msg_type, char *data,
 ...
 * disconnected.
 */
int handle_message(uint64_t id, uint8_t msg_type, char *data, int data_len,
